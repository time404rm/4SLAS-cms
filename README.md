...
- **Два языка** — русский и английский (переключается на лету через `__()`)
...
- **Drag-and-drop расширение** — GrapesJS (устанавливается отдельно через админку)
...
**Разработчик:** [ruslanabuzyaroff](https://t.me/time4_04)  
