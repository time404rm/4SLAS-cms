...
### Код с подсветкой
В редакторе есть кнопка **</>** — она открывает окошко, где можно вставить код. Выбираешь язык (PHP, JS, HTML, CSS, SQL, Python, Java, C++, C#, Go, Ruby, JSON, XML, Bash, Markdown — 15 штук), и код сразу подсвечивается цветами. Без всяких внешних библиотек, своими руками через регулярки.
